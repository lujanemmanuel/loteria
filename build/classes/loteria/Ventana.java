...
import static loteria.Eleccion.cartMaq;
import static loteria.Eleccion.jugador;
import static loteria.Eleccion.seleccionada;
public class Ventana extends javax.swing.JFrame{
    ...
    public static String voz="mujer1";
    public Ventana() {
        this.reproduce = new Reproducir();
        ...
        jug1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+seleccionada[0][0]+".png")));
        jug2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+seleccionada[0][1]+".png")));
        jug3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+seleccionada[0][2]+".png")));
        jug4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+seleccionada[0][3]+".png")));
        jug5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+seleccionada[1][0]+".png")));
        jug6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+seleccionada[1][1]+".png")));
        jug7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+seleccionada[1][2]+".png")));
        jug8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+seleccionada[1][3]+".png")));
        jug9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+seleccionada[2][0]+".png")));
        jug10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+seleccionada[2][1]+".png")));
        jug11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+seleccionada[2][2]+".png")));
        jug12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+seleccionada[2][3]+".png")));
        jug13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+seleccionada[3][0]+".png")));
        jug14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+seleccionada[3][1]+".png")));
        jug15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+seleccionada[3][2]+".png")));
        jug16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+seleccionada[3][3]+".png")));
        
        maq1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+cartMaq[0][0]+".png")));
        maq2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+cartMaq[0][1]+".png")));
        maq3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+cartMaq[0][2]+".png")));
        maq4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+cartMaq[0][3]+".png")));
        maq5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+cartMaq[1][0]+".png")));
        maq6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+cartMaq[1][1]+".png")));
        maq7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+cartMaq[1][2]+".png")));
        maq8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+cartMaq[1][3]+".png")));
        maq9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+cartMaq[2][0]+".png")));
        maq10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+cartMaq[2][1]+".png")));
        maq11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+cartMaq[2][2]+".png")));
        maq12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+cartMaq[2][3]+".png")));
        maq13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+cartMaq[3][0]+".png")));
        maq14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+cartMaq[3][1]+".png")));
        maq15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+cartMaq[3][2]+".png")));
        maq16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Miniaturas/"+cartMaq[3][3]+".png")));
        for (int a=0; a<4; a++){
            for (int  b=0; b<4; b++){
    ...
    public void Reproducir_sonido(String sonido){
        String Son;
          try {
              ...
              Son="C:\\Users\\HP\\Documents\\NetBeansProjects\\Loteria\\src\\Baraja_"+voz+"\\"+sonido+".mp3";
            FileInputStream fis;
            Player player;
                ...
                public void run() {
                             ...
                             switch (contador){
                                 ...
                                 case 0:
                                     ...
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(0)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 1:
                                    contador=2;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(1)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 2:
                                    contador=3;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(2)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 3:
                                     contador=4;
                                     restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(3)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 4:
                                    contador=5;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(4)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 5:
                                    contador=6;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(5)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 6:
                                     contador=7;
                                     restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(6)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 7:
                                    contador=8;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(7)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 8:
                                    contador=9;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(8)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 9:
                                     contador=10;
                                     restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(9)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 10:
                                    contador=11;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(10)+".png"));
                                     bara.setIcon(icono);
                                     pasadas.add(barajeada.get(10));
                                     pasada=(String) barajeada.get(10);
                                     buscar_carta(pasada);carta=(String) barajeada.get(0);
                                ...
                                case 11:
                                    contador=12;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(11)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 12:
                                     contador=13;
                                     restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(12)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 13:
                                    contador=14;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(13)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 14:
                                    contador=15;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(14)+".png"));
                                     bara.setIcon(icono);
                                    ...
                                    case 15:
                                     contador=16;
                                     restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(15)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 16:
                                    contador=17;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(16)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 17:
                                    contador=18;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(17)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 18:
                                     contador=19;
                                     restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(18)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 19:
                                    contador=20;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(19)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 20:
                                    contador=21;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(20)+".png"));
                                     bara.setIcon(icono);
                                    ...
                                    case 21:
                                     contador=22;
                                     restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(21)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 22:
                                    contador=23;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(22)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 23:
                                    contador=24;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(23)+".png"));
                                     bara.setIcon(icono);
                                    ...
                                    case 24:
                                     contador=25;
                                     restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(24)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 25:
                                    contador=26;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(25)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 26:
                                    contador=27;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(26)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 27:
                                     contador=28;
                                     restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(27)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 28:
                                    contador=29;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(28)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 29:
                                    contador=30;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(29)+".png"));
                                     bara.setIcon(icono);
                               ...
                               case 30:
                                     contador=31;
                                     restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(30)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 31:
                                    contador=32;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(31)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 32:
                                    contador=33;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(32)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 33:
                                     contador=34;
                                     restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(33)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 34:
                                    contador=35;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(34)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 35:
                                    contador=36;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(35)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 36:
                                     contador=37;
                                     restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(36)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 37:
                                    contador=38;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(37)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 38:
                                    contador=39;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(38)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 39:
                                     contador=40;
                                     restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(39)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 40:
                                    contador=41;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(40)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 41:
                                    contador=42;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(41)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 42:
                                     contador=43;
                                     restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(42)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 43:
                                    contador=44;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(43)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 44:
                                    contador=45;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(44)+".png"));
                                     bara.setIcon(icono);
                                    ...
                                    case 45:
                                     contador=46;
                                     restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(45)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 46:
                                    contador=47;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(46)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 47:
                                    contador=48;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(47)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 48:
                                     contador=49;
                                     restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(48)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 49:
                                    contador=50;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(49)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 50:
                                    contador=51;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(50)+".png"));
                                     bara.setIcon(icono);
                                    ...
                                    case 51:
                                     contador=52;
                                     restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(51)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 52:
                                    contador=53;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(52)+".png"));
                                     bara.setIcon(icono);
                                ...
                                case 53:
                                    contador=54;
                                    restl.setText("Cartas restantes: "+String.valueOf(54-contador));
                                     icono= new ImageIcon(getClass().getResource("/Baraja/c"+barajeada.get(53)+".png"));
                                     bara.setIcon(icono);
